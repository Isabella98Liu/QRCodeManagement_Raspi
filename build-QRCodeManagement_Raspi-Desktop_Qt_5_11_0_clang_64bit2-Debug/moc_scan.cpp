...
#include "../QRCodeManagement_Raspi/3_Scan/scan.h"
...
QT_MOC_LITERAL(4, 42, 12), // "captureImage"
QT_MOC_LITERAL(5, 55, 9) // "saveImage"

    },
    "Scan\0buttonClicked\0\0on_pushButton_clicked\0"
    "captureImage\0saveImage"
};
...
void Scan::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->saveImage((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QImage(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Scan::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scan::buttonClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Scan::staticMetaObject = {
